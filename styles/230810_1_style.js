...
var style_230810_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_230810_1(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_230810_1rule0_eval_expression(context)) {
        ...
        var style = rules_230810_1(feature, value);
        ;
